...
public class EnterpriseCredit {
    ...
    public String enterpriseSearch2(Map<String,String> map,String uri){
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(CreditPropertyUtil.instance.getPropertyValue("credit.enterprise.search.page2")+uri);//http://11.156.206.11:8001/credituniontest/queryAction.do
