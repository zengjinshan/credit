...
@Entity
@Table(name = "EC_NR_UN_LoanInfo")
public class EcNrUnLoaninfo {
	@Id
    @Column(name = "UN_LoanInfo_id",length = 40,nullable = false)
    private String unLoaninfoId;
    ...
    public String getUnLoaninfoId() {
        return unLoaninfoId;
    }

    public void setUnLoaninfoId(String unLoaninfoId) {
        this.unLoaninfoId = unLoaninfoId == null ? null : unLoaninfoId.trim();
    }
