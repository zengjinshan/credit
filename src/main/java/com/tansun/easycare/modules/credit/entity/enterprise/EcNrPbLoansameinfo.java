...
@Entity
@Table(name = "EC_NR_PB_LoanSameInfo")
public class EcNrPbLoansameinfo {
	
	@Id
    @Column(name = "PB_LoanSameInfo_id",length = 40,nullable = false)
    private String pbLoansameinfoId;
    ...
    public String getPbLoansameinfoId() {
        return pbLoansameinfoId;
    }

    public void setPbLoansameinfoId(String pbLoansameinfoId) {
        this.pbLoansameinfoId = pbLoansameinfoId == null ? null : pbLoansameinfoId.trim();
    }
