...
@Entity
@Table(name = "EC_NR_UN_TradeFinancing")
public class EcNrUnTradefinancing {
	@Id
    @Column(name = "UN_TradeFinancing_id",length = 40,nullable = false)
    private String unTradefinancingId;
    ...
    public String getUnTradefinancingId() {
        return unTradefinancingId;
    }

    public void setUnTradefinancingId(String unTradefinancingId) {
        this.unTradefinancingId = unTradefinancingId == null ? null : unTradefinancingId.trim();
    }
