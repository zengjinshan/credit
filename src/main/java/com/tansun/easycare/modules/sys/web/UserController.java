...
import com.tansun.easycare.modules.sys.entity.qo.UserQueryVo;
...
public class UserController extends BaseController {
	...
	public String index(User user, HttpServletResponse response, Model model) {
		CookieUtils.setCookie(response, "ck_user", "");
	...
	public void setQueryCondition(UserQueryVo user, HttpServletRequest request, HttpServletResponse response){
		CookieUtils.setCookie(response, "ck_user", JsonMapper.toJsonString(user));
	}
	
	@RequiresPermissions("sys:user:view")
	@RequestMapping(value = "")
	public String initList(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
		String reqString = CookieUtils.getCookie(request, "ck_user");
