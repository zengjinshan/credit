...
import com.tansun.easycare.modules.sys.entity.vo.MenuVo;
...
public class UserUtils {
	...
	public static List<MenuVo> getUserMenuList(){
		List<MenuVo> retMenuList = new ArrayList<MenuVo>();
		List<Menu> menuList = getMenuList();
		for (Menu menu : menuList) {
			if (Global.HIDE.equals(menu.getIsShow())) {// 过滤隐藏菜单
				continue;
			}
			MenuVo menuVo = new MenuVo();
			BeanUtils.copyProperties(menu, menuVo);
			menuVo.setParentId(menu.getParentId());
			retMenuList.add(menuVo);
		}
		return retMenuList;
	}
