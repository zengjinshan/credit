...
$.extend(Datepicker.prototype, {
	...
	_gotoToday: function(id) {
		...
		/*ie浏览器中，日期控件在选中时间后，日期弹出框会重复弹出，为了处理这个bug，调整代码位置，将_adjustDate调整到_selectDate后面*/
	...
	_selectDay: function(id, month, year, td) {
		...
		/*ie浏览器中，日期控件在选中时间后，日期弹出框会重复弹出，为了处理这个bug，添加下行代码*/
		this._adjustDate(target);
	},
...
//					$.datepicker._hideDatepicker();
					// 重新定义一个方法，用于关闭日期弹出框
					$.datepicker._closeDatepicker(id);
				},
				today: function () {
...
var dialog = $.widget( "ui.dialog", {
	...
	_createTitlebar: function() {
		...
		// dialog in IE (#9312)
		this.uiDialogTitlebarClose = $( "<button type='button' class='btn_closewhite'></button>" )
			.button({
				//label: this.options.closeText,/*close_icon------title%alt*/
				icons: {
