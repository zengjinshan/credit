...
<head>
	...
	<script src="${ctxStatic}/modules/js/sys/areaForm.js" type="text/javascript"></script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:area:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
