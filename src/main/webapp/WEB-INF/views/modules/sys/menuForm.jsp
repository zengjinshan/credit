...
<head>
	...
	<script src="${ctxStatic}/modules/js/sys/menuForm.js" type="text/javascript"></script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:menu:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
