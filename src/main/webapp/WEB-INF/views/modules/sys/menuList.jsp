...
<head>
	...
	<script src="${ctxStatic}/modules/js/sys/menuList.js" type="text/javascript"></script>
</head>
<body>
	...
	<form id="listForm" method="post">
		...
		<shiro:hasPermission name="sys:menu:edit">
			<div class="form-actions pagination-left">
				<button class="btn_public" type="button" onclick="menuList.updateSort();"><i class="icon button_save"></i>保存排序</button>
			</div>
		</shiro:hasPermission>
	 </form>
</body>
