...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqIStReportstatus" action="${ctx}/fxq/fxqIStReportstatus/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIStReportstatus:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
