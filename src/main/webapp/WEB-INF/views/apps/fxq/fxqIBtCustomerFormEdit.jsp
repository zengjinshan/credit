...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqIBtCustomer" action="${ctx}/fxq/fxqIBtCustomer/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<input type="hidden" id="checkInfoTab" value="${fxqIBtCustomer.checkInfo}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIBtCustomer:modify"><button class="btn_public" type="button" onclick="fxqIBtCustomerForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
