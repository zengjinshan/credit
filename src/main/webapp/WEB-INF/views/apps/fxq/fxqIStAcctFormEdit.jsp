...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqIStAcct" action="${ctx}/fxq/fxqIStAcct/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<input type="hidden" id="modiInfoTab" value="${fxqIStAcct.modiInfo}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIStAcct:modify"><button class="btn_public" type="button" onclick="fxqIStAcctForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
