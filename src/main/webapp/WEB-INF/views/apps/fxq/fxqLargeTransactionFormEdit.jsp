...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqLargeTransaction" action="${ctx}/fxq/fxqLargeTransaction/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<input type="hidden" id="checkInfoTab" value="${fxqLargeTransaction.checkInfo}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqLargeTransaction:edit"><button class="btn_public" type="button" onclick="fxqLargeTransactionForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
