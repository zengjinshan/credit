...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqIStTransaction" action="${ctx}/fxq/fxqIStTransaction/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<input type="hidden" id="modiInfoTab" value="${fxqIStTransaction.modiInfo}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIStTransaction:modify"><button class="btn_public" type="button" onclick="fxqIStTransactionForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
