...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqDubiousCase" action="${ctx}/fxq/fxqDubiousCase/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqDubiousCase:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
