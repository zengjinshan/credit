...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqIStAcct" action="${ctx}/fxq/fxqIStAcct/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="openDt" htmlEscape="false" maxlength="10" class="input-large required"/>
					</div>
				</div>
			</div>
		</div>
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="closeDt" htmlEscape="false" maxlength="10" class="input-large required"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIStAcct:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
