...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqIBtRelation" action="${ctx}/fxq/fxqIBtRelation/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="reportId" htmlEscape="false" maxlength="19" class="input-large required" disabled="true"/>
						<span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIBtRelation:edit"><button class="btn_public" type="button" onclick="fxqIBtRelationForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
