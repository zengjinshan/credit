...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqIStCustomer" action="${ctx}/fxq/fxqIStCustomer/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<input type="hidden" id="modiInfoTab" value="${fxqIStCustomer.modiInfo}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIStCustomer:modify"><button class="btn_public" type="button" onclick="fxqIStCustomerForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
