...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqIStRelation" action="${ctx}/fxq/fxqIStRelation/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="reportId" htmlEscape="false" maxlength="20" class="input-large required" disabled="true"/>
						<span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			</div>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="txId" htmlEscape="false" maxlength="20" class="input-large required" disabled="true"/>
						<span class="help-inline"><font color="red">*</font> </span>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqIStRelation:edit"><button class="btn_public" type="button" onclick="fxqIStRelationForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
