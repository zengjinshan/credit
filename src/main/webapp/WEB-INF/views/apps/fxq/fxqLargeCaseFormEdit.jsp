...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqLargeCase" action="${ctx}/fxq/fxqLargeCase/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqLargeCase:edit"><button class="btn_public" type="button" onclick="fxqLargeCaseForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
