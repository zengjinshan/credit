...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqDubiousTransaction" action="${ctx}/fxq/fxqDubiousTransaction/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="fxqOrg" htmlEscape="false" maxlength="9" class="input-large "/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<input type="hidden" id="modiInfoTab" value="${fxqDubiousTransaction.modiInfo}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxq:fxqDubiousTransaction:edit"><button class="btn_public" type="button" onclick="fxqDubiousTransactionForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
