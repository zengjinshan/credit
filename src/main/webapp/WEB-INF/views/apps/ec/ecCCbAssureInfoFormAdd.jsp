...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCCbAssureInfo" action="${ctx}/ec/ecCCbAssureInfo/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbAssureInfo:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
