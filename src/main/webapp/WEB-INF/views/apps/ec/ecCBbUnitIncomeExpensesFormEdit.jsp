...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBbUnitIncomeExpenses" action="${ctx}/ec/ecCBbUnitIncomeExpenses/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbUnitIncomeExpenses:modify"><button class="btn_public" type="button" onclick="ecCBbUnitIncomeExpensesForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
