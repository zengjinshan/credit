...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCCbOpenCreditBusi" action="${ctx}/ec/ecCCbOpenCreditBusi/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="creditAgrNo" htmlEscape="false" maxlength="60" class="input-large required" disabled="true"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbOpenCreditBusi:modify"><button class="btn_public" type="button" onclick="ecCCbOpenCreditBusiForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
