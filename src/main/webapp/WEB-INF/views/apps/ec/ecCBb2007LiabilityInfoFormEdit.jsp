...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBb2007LiabilityInfo" action="${ctx}/ec/ecCBb2007LiabilityInfo/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBb2007LiabilityInfo:modify"><button class="btn_public" type="button" onclick="ecCBb2007LiabilityInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
