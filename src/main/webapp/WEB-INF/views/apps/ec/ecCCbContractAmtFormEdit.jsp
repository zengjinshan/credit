...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCCbContractAmt" action="${ctx}/ec/ecCCbContractAmt/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="loanContractAmt" htmlEscape="false" class="input-large "/>
					</div>
				</div>
			</div>
		</div>
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="useableBalance" htmlEscape="false" class="input-large "/>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbContractAmt:modify"><button class="btn_public" type="button" onclick="ecCCbContractAmtForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
