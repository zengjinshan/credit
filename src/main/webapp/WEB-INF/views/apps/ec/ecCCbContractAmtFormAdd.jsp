...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCCbContractAmt" action="${ctx}/ec/ecCCbContractAmt/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbContractAmt:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
