...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBbUnitLiabilityInfo" action="${ctx}/ec/ecCBbUnitLiabilityInfo/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbUnitLiabilityInfo:modify"><button class="btn_public" type="button" onclick="ecCBbUnitLiabilityInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
