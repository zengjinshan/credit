...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCCbLoanExtensionInfo" action="${ctx}/ec/ecCCbLoanExtensionInfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="extensionTimes" htmlEscape="false" maxlength="8" class="input-large required digits"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbLoanExtensionInfo:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
