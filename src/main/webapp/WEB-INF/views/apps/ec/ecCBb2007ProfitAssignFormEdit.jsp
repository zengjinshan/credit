...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBb2007ProfitAssign" action="${ctx}/ec/ecCBb2007ProfitAssign/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBb2007ProfitAssign:modify"><button class="btn_public" type="button" onclick="ecCBb2007ProfitAssignForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
