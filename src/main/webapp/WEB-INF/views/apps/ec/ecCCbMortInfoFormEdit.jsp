...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCCbMortInfo" action="${ctx}/ec/ecCCbMortInfo/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="mortSerialNo" htmlEscape="false" maxlength="13" class="input-large required" disabled="true"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="mortNo" htmlEscape="false" maxlength="80" class="input-large required" disabled="true"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbMortInfo:modify"><button class="btn_public" type="button" onclick="ecCCbMortInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
