...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCCbGuarInfo" action="${ctx}/ec/ecCCbGuarInfo/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbGuarInfo:modify"><button class="btn_public" type="button" onclick="ecCCbGuarInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
