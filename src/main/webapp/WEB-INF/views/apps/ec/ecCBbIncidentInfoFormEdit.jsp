...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBbIncidentInfo" action="${ctx}/ec/ecCBbIncidentInfo/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="incidentNo" htmlEscape="false" maxlength="60" class="input-large "/>
					</div>
				</div>
			</div>
		</div>
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="incidentDesc" htmlEscape="false" maxlength="400" class="input-large "/>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbIncidentInfo:modify"><button class="btn_public" type="button" onclick="ecCBbIncidentInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
