...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCCbReciptDiscountBusi" action="${ctx}/ec/ecCCbReciptDiscountBusi/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="reciptInNo" htmlEscape="false" maxlength="60" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbReciptDiscountBusi:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
