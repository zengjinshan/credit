...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCCbDuebillInfo" action="${ctx}/ec/ecCCbDuebillInfo/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbDuebillInfo:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
