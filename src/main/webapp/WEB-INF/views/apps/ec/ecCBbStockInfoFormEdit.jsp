...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBbStockInfo" action="${ctx}/ec/ecCBbStockInfo/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="stockId" htmlEscape="false" maxlength="13" class="input-large required digits" disabled="true"/>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="stockCd" htmlEscape="false" maxlength="10" class="input-large "/>
					</div>
			 	</div>
		 		<div class="span6">	 
					<label class="control-label">上市地：</label>
					<div class="controls">
						<form:select path="stockAddr" class="input-large ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('EC_STOCK_ADDR')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbStockInfo:modify"><button class="btn_public" type="button" onclick="ecCBbStockInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
