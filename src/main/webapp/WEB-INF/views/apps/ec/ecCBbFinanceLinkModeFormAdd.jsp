...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCBbFinanceLinkMode" action="${ctx}/ec/ecCBbFinanceLinkMode/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="addressId" htmlEscape="false" maxlength="12" class="input-large required digits"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbFinanceLinkMode:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
