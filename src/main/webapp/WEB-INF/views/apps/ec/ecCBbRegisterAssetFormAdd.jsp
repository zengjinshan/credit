...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCBbRegisterAsset" action="${ctx}/ec/ecCBbRegisterAsset/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbRegisterAsset:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
