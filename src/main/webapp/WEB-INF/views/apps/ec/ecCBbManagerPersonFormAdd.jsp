...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCBbManagerPerson" action="${ctx}/ec/ecCBbManagerPerson/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="managerPersonId" htmlEscape="false" maxlength="13" class="input-large required digits"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbManagerPerson:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
