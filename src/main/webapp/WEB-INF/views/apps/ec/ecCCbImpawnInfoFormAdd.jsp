...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ecCCbImpawnInfo" action="${ctx}/ec/ecCCbImpawnInfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="occurDate" htmlEscape="false" maxlength="8" class="input-large required"/>
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="impawnSerialNo" htmlEscape="false" maxlength="13" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="impawnNo" htmlEscape="false" maxlength="80" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbImpawnInfo:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
