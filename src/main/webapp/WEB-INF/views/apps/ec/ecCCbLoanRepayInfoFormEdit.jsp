...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCCbLoanRepayInfo" action="${ctx}/ec/ecCCbLoanRepayInfo/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="repayInfoId" htmlEscape="false" maxlength="13" class="input-large required digits" disabled="true"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCCbLoanRepayInfo:modify"><button class="btn_public" type="button" onclick="ecCCbLoanRepayInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
