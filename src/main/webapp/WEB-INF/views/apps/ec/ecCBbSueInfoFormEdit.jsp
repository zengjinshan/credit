...
<body>
	...
	<form:form id="inputForm" modelAttribute="ecCBbSueInfo" action="${ctx}/ec/ecCBbSueInfo/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ec:ecCBbSueInfo:modify"><button class="btn_public" type="button" onclick="ecCBbSueInfoForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
