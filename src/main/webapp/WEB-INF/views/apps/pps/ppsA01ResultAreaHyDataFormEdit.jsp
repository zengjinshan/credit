...
<body>
	...
	<form:form id="inputForm" modelAttribute="ppsA01ResultAreaHyData" action="${ctx}/pps/ppsA01ResultAreaHyData/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pps:ppsA01ResultAreaHyData:edit"><button class="btn_public" type="button" onclick="ppsA01ResultAreaHyDataForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
