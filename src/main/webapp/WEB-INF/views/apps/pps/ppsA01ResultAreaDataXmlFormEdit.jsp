...
<body>
	...
	<form:form id="inputForm" modelAttribute="ppsA01ResultAreaDataXml" action="${ctx}/pps/ppsA01ResultAreaDataXml/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pps:ppsA01ResultAreaDataXml:edit"><button class="btn_public" type="button" onclick="ppsA01ResultAreaDataXmlForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
