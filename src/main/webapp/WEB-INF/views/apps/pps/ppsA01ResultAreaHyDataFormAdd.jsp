...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="ppsA01ResultAreaHyData" action="${ctx}/pps/ppsA01ResultAreaHyData/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="inIndustryCd" htmlEscape="false" maxlength="10" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
			 	</div>
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="inIndustryName" htmlEscape="false" maxlength="100" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="outIndustryCd" htmlEscape="false" maxlength="10" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
			 	</div>
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="outIndustryName" htmlEscape="false" maxlength="100" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="pps:ppsA01ResultAreaHyData:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
