...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqICrrIndvClassRslt" action="${ctx}/fxqbl/fxqICrrIndvClassRslt/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:select path="classResultType" class="input-large required">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<input id="setupBizRelaTm" name="setupBizRelaTm" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="${fxqICrrIndvClassRslt.setupBizRelaTm}"
							onclick="WdatePicker({dateFmt:'yyyyMMdd',isShowClear:false});"/>
					</div>
				</div>
			</div>
		 		...
		 		<div class="span6">
					...
					<div class="controls">
						<input id="endBizRelaTm" name="endBizRelaTm" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="${fxqICrrIndvClassRslt.endBizRelaTm}"
							onclick="WdatePicker({dateFmt:'yyyyMMdd',isShowClear:false});"/>
					</div>
			 	</div>
		 		<div class="span6">	 
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<input id="hhReportStartDate" name="hhReportStartDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="${fxqICrrIndvClassRslt.hhReportStartDate}"
							onclick="WdatePicker({dateFmt:'yyyyMMdd',isShowClear:false});"/>
					</div>
				</div>
			</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqICrrIndvClassRslt:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
