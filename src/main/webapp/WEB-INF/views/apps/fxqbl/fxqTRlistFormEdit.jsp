...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqTRlist" action="${ctx}/fxqbl/fxqTRlist/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqTRlist:modify"><button class="btn_public" type="button" onclick="fxqTRlistForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
