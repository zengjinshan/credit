...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqICrrIndvClassRslt" action="${ctx}/fxqbl/fxqICrrIndvClassRslt/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<input type="hidden" id="classResultType" name="classResultType" value="${fxqICrrIndvClassRslt.classResultType}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqICrrIndvClassRslt:modify"><button class="btn_public" type="button" onclick="fxqICrrIndvClassRsltForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
