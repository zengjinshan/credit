...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="fxqICrrIndvClassHis" action="${ctx}/fxqbl/fxqICrrIndvClassHis/save" method="post" class="form-horizontal">
		 		...
		 		<div class="span6">
					...
					<div class="controls">
						<input id="endDate" name="endDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="${fxqICrrIndvClassHis.endDate}"
							onclick="WdatePicker({dateFmt:'yyyyMMdd',isShowClear:false});"/>
					</div>
			 	</div>
		 		<div class="span6">	 
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<input id="lastDealDt" name="lastDealDt" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="${fxqICrrIndvClassHis.lastDealDt}"
							onclick="WdatePicker({dateFmt:'yyyyMMdd',isShowClear:false});"/>
					</div>
				</div>
			</div>
		 		...
		 		<div class="span6">
					...
					<div class="controls">
						<input id="auditDate" name="auditDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="${fxqICrrIndvClassHis.auditDate}"
							onclick="WdatePicker({dateFmt:'yyyyMMdd',isShowClear:false});"/>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqICrrIndvClassHis:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
