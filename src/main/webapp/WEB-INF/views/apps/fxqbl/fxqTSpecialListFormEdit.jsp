...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqTSpecialList" action="${ctx}/fxqbl/fxqTSpecialList/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqTSpecialList:modify"><button class="btn_public" type="button" onclick="fxqTSpecialListForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
