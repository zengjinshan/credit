...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqICrrIndvClassHis" action="${ctx}/fxqbl/fxqICrrIndvClassHis/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqICrrIndvClassHis:modify"><button class="btn_public" type="button" onclick="fxqICrrIndvClassHisForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
