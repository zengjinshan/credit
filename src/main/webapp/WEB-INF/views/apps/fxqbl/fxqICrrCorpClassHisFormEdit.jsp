...
<body>
	...
	<form:form id="inputForm" modelAttribute="fxqICrrCorpClassHis" action="${ctx}/fxqbl/fxqICrrCorpClassHis/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="fxqbl:fxqICrrCorpClassHis:modify"><button class="btn_public" type="button" onclick="fxqICrrCorpClassHisForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
