...
<body>
	...
	<form:form id="inputForm" modelAttribute="pcBusiDelete" action="${ctx}/pc/pcBusiDelete/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pc:pcBusiDelete:modify"><button class="btn_public" type="button" onclick="pcBusiDeleteForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
