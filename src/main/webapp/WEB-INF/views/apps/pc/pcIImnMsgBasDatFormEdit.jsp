...
<body>
	...
	<form:form id="inputForm" modelAttribute="pcIImnMsgBasDat" action="${ctx}/pc/pcIImnMsgBasDat/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pc:pcIImnMsgBasDat:modify"><button class="btn_public" type="button" onclick="pcIImnMsgBasDatForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
