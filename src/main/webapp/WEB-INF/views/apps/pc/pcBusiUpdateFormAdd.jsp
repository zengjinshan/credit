...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="pcBusiUpdate" action="${ctx}/pc/pcBusiUpdate/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pc:pcBusiUpdate:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
