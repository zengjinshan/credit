...
<body>
	...
	<form:form id="inputForm" modelAttribute="tf100405Acct" action="${ctx}/tf/tf100405Acct/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="transSerialNumber" id="tsnFormAddAcct" htmlEscape="false" maxlength="53" class="input-large required"/>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="accountSerial" htmlEscape="false" maxlength="8" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tf100405Acct:add"><button class="btn_public" type="button" id="save"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
