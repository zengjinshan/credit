...
<body>
	...
	<form:form id="inputForm" modelAttribute="tf100405Main" action="${ctx}/tf/tf100405Main/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tf100405Main:modify"><button class="btn_public" type="button" onclick="tf100405MainForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
