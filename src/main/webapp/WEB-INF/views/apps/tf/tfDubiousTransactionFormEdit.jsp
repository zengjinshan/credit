...
<body>
	...
	<form:form id="inputForm" modelAttribute="tfDubiousTransaction" action="${ctx}/tf/tfDubiousTransaction/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfDubiousTransaction:edit"><button class="btn_public" type="button" onclick="tfDubiousTransactionForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
