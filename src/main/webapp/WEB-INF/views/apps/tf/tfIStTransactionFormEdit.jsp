...
<body>
	...
	<form:form id="inputForm" modelAttribute="tfIStTransaction" action="${ctx}/tf/tfIStTransaction/update" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfIStTransaction:edit"><button class="btn_public" type="button" onclick="tfIStTransactionForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
