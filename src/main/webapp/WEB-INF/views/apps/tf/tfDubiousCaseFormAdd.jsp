...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="tfDubiousCase" action="${ctx}/tf/tfDubiousCase/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfDubiousCase:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
