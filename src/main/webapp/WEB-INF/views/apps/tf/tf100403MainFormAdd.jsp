...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="tf100403Main" action="${ctx}/tf/tf100403Main/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="transSerialNumber" htmlEscape="false" maxlength="53" class="input-large "/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tf100403Main:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
