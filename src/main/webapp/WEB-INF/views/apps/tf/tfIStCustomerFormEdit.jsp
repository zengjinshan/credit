...
<body>
	...
	<form:form id="inputForm" modelAttribute="tfIStCustomer" action="${ctx}/tf/tfIStCustomer/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<input type="hidden" id="tfStcrTab" value="${tfIStCustomer.tfStcr}"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfIStCustomer:edit"><button class="btn_public" type="button" onclick="tfIStCustomerForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
