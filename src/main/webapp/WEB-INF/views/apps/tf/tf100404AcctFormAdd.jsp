...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="tf100404Acct" action="${ctx}/tf/tf100404Acct/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="transSerialNumber" id="tsn404FormAddAcct" htmlEscape="false" maxlength="106" class="input-large required"/>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="accountSerial" id="as404acctFormAdd" htmlEscape="false" maxlength="16" class="input-large required"/>
						<span class="help-inline"><font color="red">*</font></span>
					</div>
			 	</div>
		 		<div class="span6">	 
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tf100404Acct:add"><button id="save" class="btn_public" type="button"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
