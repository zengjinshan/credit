...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="tfDubiousCase" action="${ctx}/tf/tfDubiousCase/adviseUpdate" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfDubiousCase:advise"><button class="btn_public" type="button" onclick="tfDubiousCaseForm.advise();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
