...
<body>
	...
	<form:form id="inputForm" modelAttribute="tfDubiousCase" action="${ctx}/tf/tfDubiousCase/update" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:select path="ctlSharehdCertType" class="input-large ">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('FXQ_CERT_TYPE')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfDubiousCase:edit"><button class="btn_public" type="button" onclick="tfDubiousCaseForm.edit();"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
