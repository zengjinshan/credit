...
<body>
	...
	<form:form id="inputForm" modelAttribute="tf100404Main" action="${ctx}/tf/tf100404Main/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="transSerialNumber" htmlEscape="false" maxlength="106" class="input-large required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tf100404Main:add"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
