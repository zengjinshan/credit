...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="tfIStCustomer" action="${ctx}/tf/tfIStCustomer/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:select path="tfStcr" class="input-large-select-edit " multiple="true">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:input path="ssdg" htmlEscape="false" maxlength="2" class="input-large "/>
					</div>
				</div>
			</div>
		</div>
		<div class="control-group">
		 	<div class="container-fluid">
		 		<div class="span6">
					...
					<div class="controls">
						<form:input path="tkms" htmlEscape="false" maxlength="300" class="input-large "/>
					</div>
			 	</div>
		 		<div class="span6">	 
					<label class="control-label">可疑行为描述：</label>
					<div class="controls">
						<form:input path="ssds" htmlEscape="false" maxlength="3000" class="input-large "/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
		 	<div class="container-fluid">
		 		...
		 		<div class="span6">	 
					...
					<div class="controls">
						<form:select path="modiInfo" class="input-large ">
							<form:option value="" label=""/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tf:tfIStCustomer:edit"><button class="btn_public" type="submit"><i class="icon button_save"></i>保存</button>&nbsp;</shiro:hasPermission>
